...
public interface GoalAchievementsLogRepository extends JpaRepository<GoalAchievementsLog, Long> {
     ...
     boolean existsByUser_UserIdAndGoal_IdAndAchievedAtAndAchievedSuccess(Long userId, Long goalId, LocalDate achievedAt, boolean achievedSuccess);

     // 주간 달성 횟수를 조회
     int countByGoal_IdAndUser_UserIdAndAchievedSuccessAndAchievedAtBetween(
